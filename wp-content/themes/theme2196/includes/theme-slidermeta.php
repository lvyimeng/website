...
/*-----------------------------------------------------------------------------------*/
$capt_position = array("right_hl" => "Right Half", "left_hl" => "Left Half");
$capt_color = array("light" => "light", "dark" => "dark");

$prefix = 'my_';
 
$meta_box_slider = array(
	'id' => 'my-meta-box-slider',
	'title' =>  __('Slider Options', 'theme2196'),
	'page' => 'slider',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Caption', 'theme2196'),
    	   'desc' => __('Input your caption for slide (HTML tags are allowed). ', 'theme2196'),
    	   'id' => $prefix . 'slider_caption',
    	   'type' => 'textarea',
    	   'std' => ''
    	),
    	array(
    	   'name' => __('URL', 'theme2196'),
    	   'desc' => __('Input the slide URL (can be external link)', 'theme2196'),
    	   'id' => $prefix . 'slider_url',
    	   'type' => 'text',
    	   'std' => ''
    	),
		array(
    	   'name' => __('Caption position', 'theme2196'),
    	   'desc' => __('Select slider caption position', 'theme2196'),
    	   'id' => $prefix . 'slider_banner',
    	   'type' => 'select',
		   'options' => $capt_position
    	),
		array(
    	   'name' => __('Caption color scheme', 'theme2196'),
    	   'desc' => __('Select slider caption color scheme', 'theme2196'),
...
function my_show_box_slider() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for slide. ', 'theme2196').'</p>';
