...
function title_box_shortcode($atts, $content = null) {

    $output = '<h3 class="title_box">';
    $output .= do_shortcode($content);
    $output .= '</h3>';
...
add_shortcode('title_box', 'title_box_shortcode');

function title_box_alt_shortcode($atts, $content = null) {

    $output = '<h3 class="title_box_alt">';
    $output .= do_shortcode($content);
    $output .= '</h3>';
...
add_shortcode('title_box_alt', 'title_box_alt_shortcode');
