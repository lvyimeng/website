frameworkShortcodeAtts={
	attributes:[
			...
			},
			{
				label:"Type of posts",
				id:"type",
				help:"This is the type of posts. Use post slug, e.g. \"team\""
			},
			{
				label:"Post Format",
				id:"post_format",
			...
			{
				label:"The number of characters in the title excerpt",
				id:"title_excerpt_count",
				help:"How many characters are displayed in the title excerpt?"
			},
			{
