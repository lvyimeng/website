		...
		"tinymce.plugins.MyThemeShortcodes",
		{
			init: function(d,e) {
                ...
                // Title Box
								...
								var a = '[title_box]'+selectedText+'[/title_box]';
								
								tinyMCE.activeEditor.execCommand("mceInsertContent", false, a);
								
								break;
                
                // Alternative Title Box
								
								case 'title_box_alt':
								
								var a = '[title_box_alt]'+selectedText+'[/title_box_alt]';
				...
				createControl:function(d,e){
                  ...
                  c=b.addMenu({title:"HTML"});
                    ...
                    a.addWithDialog(c,"Blockquote","blockquote");
                                        ...
                                        a.addWithDialog(c,"Title Box","title_box");
                                        a.addWithDialog(c,"Alternative Title Box","title_box_alt");
