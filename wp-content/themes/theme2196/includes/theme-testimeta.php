...
$meta_box_testi = array(
	...
	'title' =>  __('Testimonial Options', 'theme2196'),
	'page' => 'testi',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Name', 'theme2196'),
    	   'desc' => __('Input author\'s name. ', 'theme2196'),
    	...
    	array(
    	   ...
    	   'desc' => __('Input author\'s URL.', 'theme2196'),
    	   'id' => $prefix . 'testi_url',
    	   'type' => 'text',
    	   'std' => ''
    	),
			array(
    	   'name' => __('Info', 'theme2196'),
    	   'desc' => __('Input author\'s additional info.', 'theme2196'),
...
function my_show_box_testi() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for testimonial. ', 'theme2196').'</p>';
