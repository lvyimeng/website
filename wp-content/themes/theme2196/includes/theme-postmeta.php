...
$meta_box_quote = array(
	...
	'title' =>  __('Quote Settings', 'theme2196'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The Quote','theme2196'),
				"desc" => __('Put your quote in this field.','theme2196'),
				"id" => $prefix."quote",
				"type" => "textarea"
			),
	),
...
$meta_box_link = array(
	'id' => 'tz-meta-box-link',
	'title' =>  __('Link Settings', 'theme2196'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The URL','theme2196'),
				"desc" => __('Insert the URL you wish to link to.','theme2196'),
				"id" => $prefix."link_url",
				"type" => "text"
			),
	),
...
$meta_box_image = array(
	...
	'title' =>  __('Image Settings', 'theme2196'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Enable Lightbox','theme2196'),
				"desc" => __('Check this to enable the lightbox.','theme2196'),
...
$meta_box_audio = array(
	...
	'title' =>  __('Audio Settings', 'theme2196'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('MP3 File URL','theme2196'),
				"desc" => __('The URL to the .mp3 audio file','theme2196'),
				"id" => $prefix."audio_mp3",
				"type" => "text"
			)
	),
...
$meta_box_video = array(
	...
	'title' =>  __('Video Settings', 'theme2196'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Embeded Code','theme2196'),
				"desc" => __('You can include embeded code here.','theme2196'),
