...
if(!function_exists('optionsframework_options')) {
	...
	function optionsframework_options() {
		...
		// Login & register links in the shop menu
		$g_add_links = array(
			"no" => "No",
			"yes" => "Yes"
		);
		...
		$options['g_add_links_id'] = array( "name" => "Display Login and Register links?",
							"desc" => "Display Login and Register links in the Shop menu?",
							"id" => "g_add_links_id",
							"type" => "radio",
							"std" => "yes",
							"options" => $g_add_links);
...
*/
add_action( 'customize_register', 'theme2196_register' );

if(!function_exists('theme2196_register')) {

	function theme2196_register($wp_customize) {
		/**
		...
		/*	General
		/*-----------------------------------------------------------------------------------*/
		$wp_customize->add_section( 'theme2196_header', array(
			'title' => __( 'General', 'theme2196' ),
			'priority' => 200
		));
		
		/* Background Image*/
		$wp_customize->add_setting( 'theme2196[body_background][image]', array(
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'body_background_image', array(
			...
			'section' => 'theme2196_header',
			'settings'   => 'theme2196[body_background][image]'
		) ) );
		
		
		/* Background Color*/
		$wp_customize->add_setting( 'theme2196[body_background][color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'body_background', array(
			...
			'section' => 'theme2196_header',
			'settings'   => 'theme2196[body_background][color]'
		) ) );
		
		/* Header Color */
		$wp_customize->add_setting( 'theme2196[header_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_color', array(
			...
			'section' => 'theme2196_header',
			'settings'   => 'theme2196[header_color]'
		) ) );
		
		
		/* Body Font Face */
		$wp_customize->add_setting( 'theme2196[google_mixed_3][face]', array(
			'default' => $options['google_mixed_3']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme2196_google_mixed_3', array(
				'label' => $options['google_mixed_3']['name'],
				'section' => 'theme2196_header',
				'settings' => 'theme2196[google_mixed_3][face]',
				'type' => 'select',
		...
		$wp_customize->add_setting( 'theme2196[links_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'links_color', array(
			...
			'section' => 'theme2196_header',
			'settings'   => 'theme2196[links_color]'
		) ) );
		
		/* H1 Heading font face */
		$wp_customize->add_setting( 'theme2196[h1_heading][face]', array(
			'default' => $options['h1_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme2196_h1_heading', array(
				'label' => $options['h1_heading']['name'],
				'section' => 'theme2196_header',
				'settings' => 'theme2196[h1_heading][face]',
				'type' => 'select',
				'choices' => $options['h1_heading']['options']['faces']
		) );
		
		/* H2 Heading font face */
		$wp_customize->add_setting( 'theme2196[h2_heading][face]', array(
			'default' => $options['h2_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme2196_h2_heading', array(
				'label' => $options['h2_heading']['name'],
				'section' => 'theme2196_header',
				'settings' => 'theme2196[h2_heading][face]',
				'type' => 'select',
				'choices' => $options['h2_heading']['options']['faces']
		) );
		
		/* H6 Heading font face */
		$wp_customize->add_setting( 'theme2196[h6_heading][face]', array(
			'default' => $options['h6_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme2196_h6_heading', array(
				'label' => $options['h6_heading']['name'],
				'section' => 'theme2196_header',
				'settings' => 'theme2196[h6_heading][face]',
				'type' => 'select',
				'choices' => $options['h6_heading']['options']['faces']
		) );
		
		/* H5 Heading font face */
		$wp_customize->add_setting( 'theme2196[h5_heading][face]', array(
			'default' => $options['h5_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme2196_h5_heading', array(
				'label' => $options['h5_heading']['name'],
				'section' => 'theme2196_header',
				'settings' => 'theme2196[h5_heading][face]',
				'type' => 'select',
				'choices' => $options['h5_heading']['options']['faces']
		) );
		
		/* H4 Heading font face */
		$wp_customize->add_setting( 'theme2196[h4_heading][face]', array(
			'default' => $options['h4_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme2196_h4_heading', array(
				'label' => $options['h4_heading']['name'],
				'section' => 'theme2196_header',
				'settings' => 'theme2196[h4_heading][face]',
				'type' => 'select',
				'choices' => $options['h4_heading']['options']['faces']
		) );
		
		/* H3 Heading font face */
		$wp_customize->add_setting( 'theme2196[h3_heading][face]', array(
			'default' => $options['h2_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'theme2196_h3_heading', array(
				'label' => $options['h3_heading']['name'],
				'section' => 'theme2196_header',
				'settings' => 'theme2196[h3_heading][face]',
				'type' => 'select',
		...
		/* Search Box */
		$wp_customize->add_setting( 'theme2196[g_search_box_id]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_g_search_box_id', array(
				'label' => $options['g_search_box_id']['name'],
				'section' => 'theme2196_header',
				'settings' => 'theme2196[g_search_box_id]',
				'type' => $options['g_search_box_id']['type'],
				'choices' => $options['g_search_box_id']['options']
		) );
		
		/* Links in shop menu */
		$wp_customize->add_setting( 'theme2196[g_add_links_id]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_g_add_links_id', array(
				'label' => $options['g_add_links_id']['name'],
				'section' => 'theme2196_header',
				'settings' => 'theme2196[g_add_links_id]',
				'type' => $options['g_add_links_id']['type'],
				'choices' => $options['g_add_links_id']['options']
		) );
		...
		$wp_customize->add_section( 'theme2196_logo', array(
			'title' => __( 'Logo', 'theme2196' ),
			'priority' => 201
		) );
		
		/* Logo Type */
		$wp_customize->add_setting( 'theme2196[logo_type]', array(
				'default' => $options['logo_type']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_logo_type', array(
				'label' => $options['logo_type']['name'],
				'section' => 'theme2196_logo',
				'settings' => 'theme2196[logo_type]',
				'type' => $options['logo_type']['type'],
				'choices' => $options['logo_type']['options']
		) );
		
		/* Logo Path */
		$wp_customize->add_setting( 'theme2196[logo_url]', array(
			'type' => 'option'
		) );
		...
		$wp_customize->add_section( 'theme2196_slider', array(
			'title' => __( 'Slider', 'theme2196' ),
			'priority' => 202
		) );
		
		/* Auto slideshow */
		$wp_customize->add_setting( 'theme2196[sl_slideshow]', array(
				'default' => $options['sl_slideshow']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_slideshow', array(
				'label' => $options['sl_slideshow']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_slideshow]',
				'type' => $options['sl_slideshow']['type'],
				'choices' => $options['sl_slideshow']['options']
		) );
		
		/* Pause time */
		$wp_customize->add_setting( 'theme2196[sl_pausetime]', array(
				'default' => $options['sl_pausetime']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_pausetime', array(
				'label' => $options['sl_pausetime']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_pausetime]',
				'type' => $options['sl_pausetime']['type']
		) );
		
		/* Slide direction */
		$wp_customize->add_setting( 'theme2196[sl_direction_type]', array(
				'default' => $options['sl_direction_type']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_direction_type', array(
				'label' => $options['sl_direction_type']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_direction_type]',
		...
		/* Slider Effect */
		$wp_customize->add_setting( 'theme2196[sl_effect]', array(
				'default' => $options['sl_effect']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_effect', array(
				'label' => $options['sl_effect']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_effect]',
		...
		/* Animation speed */
		$wp_customize->add_setting( 'theme2196[sl_animation_speed]', array(
				'default' => $options['sl_animation_speed']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_animation_speed', array(
				'label' => $options['sl_animation_speed']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_animation_speed]',
				'type' => $options['sl_animation_speed']['type']
		) );
		
		
		/* Display next & prev navigation? */
		$wp_customize->add_setting( 'theme2196[sl_dir_nav]', array(
				'default' => $options['sl_dir_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_dir_nav', array(
				'label' => $options['sl_dir_nav']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_dir_nav]',
		...
		/* Show pagination? */
		$wp_customize->add_setting( 'theme2196[sl_control_nav]', array(
				'default' => $options['sl_control_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_control_nav', array(
				'label' => $options['sl_control_nav']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_control_nav]',
		...
		/* Keyboard */
		$wp_customize->add_setting( 'theme2196[sl_keyboard]', array(
				'default' => $options['sl_keyboard']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_keyboard', array(
				'label' => $options['sl_keyboard']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_keyboard]',
		...
		/* Mousewheel */
		$wp_customize->add_setting( 'theme2196[sl_mousewheel]', array(
				'default' => $options['sl_control_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_mousewheel', array(
				'label' => $options['sl_mousewheel']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_mousewheel]',
				'type' => $options['sl_mousewheel']['type'],
				'choices' => $options['sl_mousewheel']['options']
		) );
		
		/* Randomize */
		$wp_customize->add_setting( 'theme2196[sl_randomize]', array(
				'default' => $options['sl_randomize']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_sl_randomize', array(
				'label' => $options['sl_randomize']['name'],
				'section' => 'theme2196_slider',
				'settings' => 'theme2196[sl_randomize]',
		...
		$wp_customize->add_section( 'theme2196_blog', array(
				'title' => __( 'Blog', 'theme2196' ),
				'priority' => 203
		) );
		
		/* Blog image size */
		$wp_customize->add_setting( 'theme2196[post_image_size]', array(
				'default' => $options['post_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_post_image_size', array(
				'label' => $options['post_image_size']['name'],
				'section' => 'theme2196_blog',
				'settings' => 'theme2196[post_image_size]',
				'type' => $options['post_image_size']['type'],
				'choices' => $options['post_image_size']['options']
		) );
		
		/* Single post image size */
		$wp_customize->add_setting( 'theme2196[single_image_size]', array(
				'default' => $options['single_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_single_image_size', array(
				'label' => $options['single_image_size']['name'],
				'section' => 'theme2196_blog',
				'settings' => 'theme2196[single_image_size]',
				'type' => $options['single_image_size']['type'],
				'choices' => $options['single_image_size']['options']
		) );
		
		/* Post Meta */
		$wp_customize->add_setting( 'theme2196[post_meta]', array(
				'default' => $options['post_meta']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_post_meta', array(
				'label' => $options['post_meta']['name'],
				'section' => 'theme2196_blog',
				'settings' => 'theme2196[post_meta]',
				'type' => $options['post_meta']['type'],
				'choices' => $options['post_meta']['options']
		) );
		
		/* Post Excerpt */
		$wp_customize->add_setting( 'theme2196[post_excerpt]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_post_excerpt', array(
				'label' => $options['post_excerpt']['name'],
				'section' => 'theme2196_blog',
				'settings' => 'theme2196[post_excerpt]',
		...
		$wp_customize->add_section( 'theme2196_footer', array(
			'title' => __( 'Footer', 'theme2196' ),
			'priority' => 204
		) );
			
		/* Footer Copyright Text */
		$wp_customize->add_setting( 'theme2196[footer_text]', array(
				'default' => $options['footer_text']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_footer_text', array(
				'label' => $options['footer_text']['name'],
				'section' => 'theme2196_footer',
				'settings' => 'theme2196[footer_text]',
				'type' => 'text'
		) );
		
		
		/* Display Footer Menu */
		$wp_customize->add_setting( 'theme2196[footer_menu]', array(
				'default' => $options['footer_menu']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'theme2196_footer_menu', array(
				'label' => $options['footer_menu']['name'],
				'section' => 'theme2196_footer',
				'settings' => 'theme2196[footer_menu]',
