	...
	<div class="flexslider-container">
		<div class="flexslider">
			...
			<?php
				...
				$caption_position = get_post_custom_values("my_slider_banner");
				$caption_color = $custom["my_slider_color"][0];
				if ($caption_position[0] == 'Left Half') {
					$caption_class = 'left_half';
				} elseif ($caption_position[0] == 'Right Half') {
					$caption_class = 'right_half';
				}
			?>
			<?php if(has_post_thumbnail( $the_ID)){ ?>
				...
				<?php echo "<a href='" . $url[0] . "'>";
							...
							echo "' alt=''/></a>"; ?>
							<?php if($caption[0]) { ?>
							<?php echo "<div class='flex-caption ".$caption_class." ".$caption_color."'>"; ?>
